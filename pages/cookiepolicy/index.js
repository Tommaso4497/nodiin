    ...
    <div style={{ backgroundColor: "#ff0", textAlign: "center" }}>
      ...
      <div>
        ...
        <p>
          ...
          informazioni. Vengono memorizzati sul dispositivo dell'utente quando
          il sito web viene caricato sul browser. Questi cookie ci aiutano a far
          funzionare correttamente il sito web, a renderlo più sicuro, a
          migliorare l'esperienza dell'utente, a capire come funziona il sito
          web, ad analizzare le sue prestazioni e ad analizzare cosa funziona e
          dove necessita di miglioramenti.
        </p>
      </div>
      &nbsp;
      ...
      <div>
        ...
        <p>
          ...
          un'esperienza utente migliore econtribuire a velocizzare le future
          interazioni con il nostro sito web.
        </p>
      </div>
      &nbsp;
      ...
      <a
        className={styles.ckybannerelement}
      >
        Preferenze Cookie
      </a>
      <br />
